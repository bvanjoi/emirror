  ...
  return (
    ...
    >
      ...
      <p>
        ...
        It is a good approximation, leading to accurate results even for
        small values of
        <span className='emirror-latex-inline'>\, n</span>.
      </p>
      <p>
        The version of the formula typically used in applications of is:
      </p>
      ...
      <p>
        ...
        worst-case lower bound for comparsion sorting),
      </p>
      ...
      <p>
        ...
        means means that the two quantities are asymptotic: their ratio
        tends to 1 as
        <span className='emirror-latex-inline'>\, n \,</span>
        tends to infinity.
      </p>
      ...
      <div className='emirror-latex-block'>
        \sqrt {'{2 \\pi}'} n ^ {'{n + \\frac{1}{2}}'} e ^ {'{-n}'} \le n!
        \le e ^{'{1-n}'} n ^ {'{n + \\frac{1}{2}}'}
      </div>
      <p>
