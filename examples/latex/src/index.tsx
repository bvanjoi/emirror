  ...
  return (
    emirror && (
      <EMirrorContext.Provider value={emirror}>
        <EMirrorComponent>
          <p>
            Latex plugin of EMirror. You can insert an inline-latex using
            $xxx$, or insert block-latex using $$yyy$$.
          </p>
          <p>Following is an example(copy from Wikipedia):</p>
          <hr />
          <p>
            Stirling&apos;s approximation is an approximation for
            factorials. It is a good approximation, leading to accurate
            results even for small values of
            <span className='emirror-latex-inline'>\, n</span>.
          </p>
          <p>
            The version of the formula typically used in applications of
            is:
          </p>
          ...
          <p>
            ...
            <span className='emirror-latex-inline'>\, n \to \infty</span>),
            or, by changing the base of the logarithm (for instance in the
            worst-case lower bound for comparison sorting),
          </p>
          <div className='emirror-latex-block'>
          ...
          <p>
            Where the sign{' '}
            <span className='emirror-latex-inline'>\sim</span> means that
            the two quantities are asymptotic: their ratio tends to 1 as
            <span className='emirror-latex-inline'>\, n \,</span>
            tends to infinity.
          </p>
          <p>
          ...
          <div className='emirror-latex-block'>
            \sqrt {'{2 \\pi}'} n ^ {'{n + \\frac{1}{2}}'} e ^ {'{-n}'} \le
            n! \le e ^{'{1-n}'} n ^ {'{n + \\frac{1}{2}}'}
          </div>
          <p>
            For <span className='emirror-latex-inline'>n = 1,2,3... </span>
            These follow from the more precise error bounds discussed
            below.
          </p>
        </EMirrorComponent>
