...
const DefaultEMirror = () => {
  return (
    ...
    >
      <p>
        Latex plugin of EMirror. You can insert a inline-latex using $xxx$, or
      ...
      <p>
        ...
        <span className="emirror-latex-inline">\, n \to \infty</span>) , or, by
        changing the base of the logarithm (for instance in the worst-case lower
        bound for comparsion sorting),
      </p>
      ...
      <p>
        where the sign <span className="emirror-latex-inline">\sim</span> means
        that the two quantities are asymptotic: their ratio tends to 1 as
        <span className="emirror-latex-inline">\, n \,</span>
        tends to infinity.
      </p>
      <p>
      ...
      <div className="emirror-latex-block">
        \sqrt {'{2 \\pi}'} n ^ {'{n + \\frac{1}{2}}'} e ^ {'{-n}'} \le n! \le e
        ^{'{1-n}'} n ^ {'{n + \\frac{1}{2}}'}
      </div>
      <p>
